...
Rectangle {
    ...
    Image {
        anchors.fill: parent
        source: "qrc:/mykitchen/images/background-login.jpg"
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Image {
                                ...
                                source: "qrc:/mykitchen/images/user-icon.png"
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Item {
                                ...
                                Layout.fillWidth: false
                                Layout.preferredWidth: parent.height
                                // source: "qrc:/mykitchen/images/search.png"
                                // fillMode: Image.PreserveAspectFit        
                            }
                            TextField {
                                id: passwordText
                        ...
                        Button {
                            ...
                            onClicked: {
                                if (loginAuth.login(user_name_input.text,passwordText.text)) {
                                    ...
                                    changeScreen("qrc:/mykitchen/src/qml/screens/mainScreen.qml");
                                } else {
