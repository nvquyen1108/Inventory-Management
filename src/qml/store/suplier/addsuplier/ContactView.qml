    ...
    StackLayout {
        ...
        Rectangle {
            ...
            HorizontalHeaderView {
                ...
                syncView: tableViews
                clip: true
                model: ["Sản phẩm","Mô tả","Số lượng","Đóng gói","Đơn giá","Thuế","Thành tiền"]
            }
            ScrollView {
...
//                                mainContainLoaderr.source = "qrc:/mykitchen/src/qml/store/suplier/addsuplier/suplierinfo.qml"
                                ...
                                console.log(tableViews.rowAtIndex(tableViews.index(row,column)))
                                console.log("index: " + tableViews.model.insertRows(0,1,tableViews.model.index(row, column),fullName.text,address.text,email.text,phone.text,moreInfo.text))
                            }
                        }
                        Label {
                            id: textLabelInfo
